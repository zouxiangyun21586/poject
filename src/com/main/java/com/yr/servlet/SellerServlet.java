    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if ("1".equals(i)) { // 查看或修改商品详细信息
                ...
                ps2.executeUpdate();
                ps2.close();
                //response.getWriter().write("<script>layui.use(['layer', 'laypage', 'element'], function(){layer.msg('修改成功!',{icon: 1});setTimeout('parent.location.href=parent.location.href;','1000');});</script>");
