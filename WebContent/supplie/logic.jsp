...
/* 页面加载完出现 */
        ...
        $.ajax({
            ...
            success:function(res){
                for (var i = 0; i < res.length; i++) {
                    var js = res[i];
                    $("#table").append("<tr id='jia'><td>"+js.id+"</td><td>"+js.merType+"</td><td>"+js.commo+"</td><td>"+js.money+"</td><td>"+js.origin+"</td><td>"+js.brand+"</td><td>"+js.qGp+"</td><td>"+js.storageMethod+"</td><td>"+js.number+"</td><td>"+js.upFrameTime+"</td><td><input type='button' name='sc' onclick='del(this);' value='删除'><input type='button' name='xg' onclick='upd(this);' value='修改'></td></tr>");
                }
            },
    ...
    function baoCun(bc){
        ...
        var upFrameTime = tr.find("td").eq(9).find("input").val();
        /* var panDuan = true; */
        ...
        $.ajax({
            ...
            success:function(res){
                tr.html("<td>"+id+"</td><td>"+merType+"</td><td>"+commo+"</td><td>"+money+"</td><td>"+origin+"</td><td>"+brand+"</td><td>"+qGp+"</td><td>"+storageMethod+"</td><td>"+number+"</td><td>"+upFrameTime+"</td><td><input type='button' name='sc' onclick='del(this);' value='删除'><input type='button' name='xg' onclick='upd(this);' value='修改'></td>");
    ...
    function upd(x){
        ...
        tr.html("<td>"+id+"</td>"+"<td><input type='text' id='merType' value="+merType+"></td>"+"<td><input type='text' id='commo' value="+commo+"></td>"+"<td><input type='text' id='money' value="+money+"></td>"+"<td><input type='text' id='origin' value="+origin+"></td>"+"<td><input type='text' id='brand' value="+brand+"></td>"+"<td><input type='text' id='qGp' value="+qGp+"></td>"+"<td><input type='text' id='storageMethod' value="+storageMethod+"></td>"+
                "<td><input type='text' id='number' value="+number+"></td><td>"+upFrameTime+"</td><td><input type='button' value='取消' onclick=\"upXg(this,'"+id+"','"+merType+"','"+commo+"','"+money+"','"+origin+"','"+brand+"','"+qGp+"','"+storageMethod+"','"+number+"','"+upFrameTime+"');\"><input type='button' onclick='tjbc(this);' value='保存'></td>");
    }
    
    /* 修改取消 */
    function upXg(x,a,b,c,d,e,f,g,h,i,j){
        alert("<td>"+a+"</td><td>"+b+"</td><td>"+c+"</td><td>"+d+"</td><td>"+e+"</td><td>"+f+"</td><td>"+g+"</td><td>"+h+"</td><td>"+i+"</td><td>"+j+"<td><input type='button' name='sc' onclick='del(this);' value='删除'><input type='button' name='xg' onclick='upd(this);' value='修改'></td>");
        var tr = $(x).parent().parent();
        tr.html("<td>"+a+"</td>"+"<td>"+b+"</td><td>"+c+"</td><td>"+d+"</td><td>"+e+"</td><td>"+f+"</td><td>"+g+"</td><td>"+h+"</td><td>"+i+"</td><td>"+j+"</td><td><input type='button' name='sc' onclick='del(this);' value='删除'><input type='button' name='xg' onclick='upd(this);' value='修改'></td>");
    }
