                    ...
                    <c:forEach var="su" items="${list}">
	                    ...
	                    <div class="layui-form-item">
	                        ...
	                        <div class="layui-input-block">
	                            <input type="text" id="mername" name="mername" autocomplete="off"
	                                value="${su.mername} class="layui-input">
	                        </div>
	                    </div>
	                    <div class="layui-form-item">
	                        ...
	                        <div class="layui-input-block">
	                            <input type="text" id="mermoney" name="mermoney" autocomplete="off"
	                                value="${su.mermoney} class="layui-input">
	                        </div>
	                    </div>
	                    <div class="layui-form-item">
	                        ...
	                        <div class="layui-input-block">
	                            <input type="text" id="mernumber" name="mernumber" autocomplete="off"
	                                value="${su.mernumber} class="layui-input">
	                        </div>
	                    </div>
	                    <div class="layui-form-item">
	                        <label class="layui-form-label">商品类型</label>
	                        <div class="layui-input-block" id="mertype">
	                            <select id="mertype" name="mertype" lay-filter="aihao" lay-search>
	                                <option value="">请选择商品类型</option>
	                                <option value="${su.mertype}">${su.aihao}</option>
	                    ...
	                    <div class="layui-form-item">
	                        ...
	                        <div class="layui-input-block" id="merqGp">
	                            <select value='selMot' id="merqGp" name="merqGp" lay-filter="aihao1" lay-search>
	                                <option value="">请选择商品保质期</option>
	                                <option value="${su.merqGp}">${su.aihao1}</option>
	                    ...
	                    <div class="layui-form-item">
	                        ...
	                        <div class="layui-input-block" id="merstm">
	                            <!-- <input type="text" id="merstm" name="merstm" autocomplete="off"
	                             ...
	                             <select value='stoSel' id="merstm" name="merstm" lay-filter="aihao2" lay-search>
	                                <option value="">请选择商品储藏方法</option>
	                                <option value="${su.merstm}">${su.aihao2}</option>
	                    ...
	                    <div class="layui-form-item">
	                        ...
	                        <div class="layui-input-block" id="merpack">
	                            <select value='pakSel' id="merpack" name="merpack" lay-filter="aihao3" lay-search>
	                                <option value="">请选择商品包装</option>
	                                <option value="${su.merpack}">${su.aihao3}</option>
